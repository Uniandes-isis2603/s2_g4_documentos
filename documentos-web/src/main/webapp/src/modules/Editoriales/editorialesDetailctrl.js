(function(ng){
    ...
    mod.controller('editorialesDetailCtrl', ['$scope', '$http', '$state',
        /**
         * @ngdoc controller
        ...
        function($scope,$http,$state) {
            if(($state.params.editorialId !== undefined) && ($state.params.editorialId !==null)){
                /**
                 * @ngdoc function
                 * @name getFotocopiaID
                ...
                $http.get('http://localhost:8080/documentos-web/api/editoriales/' + $state.params.editorialId).then(function(response){
