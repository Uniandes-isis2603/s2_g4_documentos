...
insert into DocumentoEntity (id,dtype,nombre,caratula,descripcion,calificacionpromedio,precio,pdf) values (100,'LibroEntity','El Amor en los Tiempos del Cólera','https://imagessl1.casadellibro.com/a/l/t0/51/9788497592451.jpg','una novela',3.2,25000,'http://biblio3.url.edu.gt/Libros/garcia_marquez/colera.pdf');
insert into DocumentoEntity (id,dtype,nombre,caratula,descripcion,calificacionpromedio,precio,pdf) values (200,'FotocopiaEntity','Calculo diferencial','https://imagessl1.casadellibro.com/a/l/t0/71/9788499690971.jpg','libro de matematicas',3.4,32000,'https://chirinossilvaroger.files.wordpress.com/2012/04/introduccic3b3n-al-cc3a1lculo-james-stewart.pdf');
insert into DocumentoEntity (id,dtype,nombre,caratula,descripcion,calificacionpromedio,precio,pdf) values (700,'LibroEntity','Cien Años de Soledad','https://imagessl9.casadellibro.com/a/l/t1/39/9788420471839.jpg','novela de Gabriel',2.3,24000,'http://bdigital.bnjm.cu/docs/libros/PROC2-435/Cien%20anos%20de%20soledad.pdf');
insert into DocumentoEntity (id,dtype,nombre,caratula,descripcion,calificacionpromedio,precio,pdf) values (800,'FotocopiaEntity', 'Fisica','https://http2.mlstatic.com/fisica-universitaria-sears-zemansky-solucionario-13a-edicion-D_NQ_NP_614007-MCO26189892253_102017-F.jpg','fotocopias de fisica',3.3,50000,'http://fis.ucv.cl/docs/fis-133/textos/Fisica-Universitaria-Sears-Zemansky-12va-Edicion-Vol1.pdf');
insert into DocumentoEntity (id,dtype,nombre,caratula,descripcion,calificacionpromedio,precio,pdf) values (900,'LibroEntity','Como Agua Para Chocolate','https://cloud10.todocoleccion.online/libros-clasicos-segunda-mano/tc/2017/04/30/00/85176408.jpg','novela',5,120000,'http://www.bibliotecaspublicas.es/merida/imagenes/Novela_Como_agua_para_chocolate.pdf');
insert into DocumentoEntity (id,dtype,nombre,caratula,descripcion,calificacionpromedio,precio,pdf) values (1000,'LibroEntity','Bajo la misma estrella','https://images-na.ssl-images-amazon.com/images/I/817tHNcyAgL.jpg','novela',3.4,12000,'http://www.bibliotecaspublicas.es/merida/imagenes/Novela_Como_agua_para_chocolate.pdf');


-- Juan Camilo
insert into DocumentoEntity (id,dtype,nombre,caratula,descripcion,calificacionpromedio,precio,pdf) values (300,'LibroEntity','Mantenimiento de computadores para ingenieros de sistemas idiotas','http://facultades.unicauca.edu.co/editorial/sites/default/files/imagenesPortada/mantenimiento_de_computadores.jpg','una novela',3.2,200000,'http://www.ciudadaniadigital.gov.co/627/articles-12648_recurso_PDF.pdf');
...
insert into DocumentoEntity (id,dtype,nombre,caratula,descripcion,calificacionpromedio,precio,pdf) values (500,'LibroEntity','Harry Poter y la piedra filosofal','https://4.bp.blogspot.com/-Pm4fx2oIF0I/WMIz7CR6qZI/AAAAAAAAAr4/W7hF85KQYV0AA6O_NHhi6J5_ov_Z6k_TgCLcB/s1600/hp1.jpg','una novela',3.2,12000,'http://www.nparangaricutiro.gob.mx/Libros/07.-%20Harry%20Potter%20Y%20Las%20Reliquias%20de%20la%20Muerte.pdf');
insert into DocumentoEntity (id,dtype,nombre,caratula,descripcion,calificacionpromedio,precio,pdf) values (600,'FotocopiaEntity','fotocopia3','https://www.virginmegastore.ae/medias/sys_master/root/h4e/h76/8818752389150/A-Game-of-Thrones-Book-1-of-A-Song-of-Ice-and-Fire-81498-Detail.jpg','libro de quimica',3.4,254250,'http://www.ing.unp.edu.ar/asignaturas/quimica/teoria/quimicaorganica.pdf');
